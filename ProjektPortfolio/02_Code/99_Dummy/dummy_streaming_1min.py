...
def fetch_and_store_stock_data():
    ...
    Löscht die bestehende tickers_data_collection beim Start des Skripts und führt eine Pause
    von einer Minute nach jedem 5. Ticker-Aufruf ein.
    """
    try:
        # MongoDB-Verbindung
        ...
        # Lösche die Collection tickers_data_collection
        tickers_data_collection.delete_many({})
        print("Die Collection 'tickers_data' wurde geleert.")
        ...
        ticker_count = 0  # Zähler für Ticker-Aufrufe
        ...
        for ticker in tickers:
            ...
            try:
                ...
                for agg in client.list_aggs(
                    ...
                    # Konvertiere das Agg-Objekt in ein Dictionary
                    agg_dict = {
                        "open": agg.open,
                        "high": agg.high,
                        "low": agg.low,
                ...
                # Zähler für Ticker-Aufrufe erhöhen
                ticker_count += 1

                # Nach jedem 5. Ticker eine Pause von 1 Minute einlegen
                if ticker_count % 5 == 0:
                    print(f"Pause von 1 Minute nach {ticker_count} Ticker-Aufrufen...")
                    import time
                    time.sleep(60)
